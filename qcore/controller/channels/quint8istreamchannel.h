#ifndef QUINT8ISTREAMCHANNEL_H
#define QUINT8ISTREAMCHANNEL_H
#include <qcore/controller/qistreamchannelcontroller.h>
#include <core/common/defaultnodes.h>

class QUInt8IStreamChannel :
        public QIStreamChannelController
{
    Q_OBJECT
public:
    QUInt8IStreamChannel(NodeID_t node_id = NodeIDNull,
    ...
    virtual NodeType_t type() const final override { return NODE_TYPE_UINT8_IPARAM; }
